...
* Relative sizing: `icon-2xs`, `icon-xs`, `icon-sm`, `icon-lg`, `icon-xl`, `icon-2xl`.
* Literal sizing: `icon-1x` to `icon-10x`.
* Flip: `icon-flip-horizontal`, `icon-flip-vertical`.
* Rotate: `icon-rotate-45`, `icon-rotate-90`, `icon-rotate-135`, `icon-rotate-180`, `icon-rotate-225`.
...
* Created by [Herb v/d Dool](https://github.com/herbdool)
